...
<head>
    ...
    <title>Kecamatan Sumobitoo</title>
    <link rel="icon" type="image/x-icon" href="img/jombang.png" />
    <!-- Bootstrap icons-->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand fw-bold" href="#page-top">Kecamatan Sumobito</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link me-lg-3" href="#download">Unduh</a></li>
                </ul>
    ...
    <div class="watermark">
        <p style="font-size: larger; text-align: center;" >Aplikasi Ini Dalam <br> Masa Ujicoba</p>
    </div>
    <!-- Mashead header-->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-5 mb-4 mb-lg-0" href="https://sfile.mobi/6a26mOlpYst"><img class="app-badge" src="img/android2.png" style="height:  80px;" alt="..." />
                                <p></p>
                            </a>
                        ...
                        <div class="device-wrapper">
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <img src="img/screen.png" style="max-width: 100%; height: 100%" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="device-wrapper">
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <!-- * * Set the max width of your media to 100% and the height to-->
                                    <!-- * * 100% like the demo example below.-->
                                    <img style="max-width: 100%; height: 100%" src="img/form.png" />
                                </div>
                            </div>
                        </div>
                    </div>
